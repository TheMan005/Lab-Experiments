...
#line 29 "postfix.y"
               { printf("Result: %g\n", yyvsp[-1]); }
#line 1079 "postfix.tab.c"
    break;

  case 6: /* exp: NUM  */
#line 34 "postfix.y"
                   { yyval = yyvsp[0]; }
#line 1085 "postfix.tab.c"
    break;
...
#line 36 "postfix.y"
                   { yyval = yyvsp[-2] - yyvsp[-1]; }
#line 1097 "postfix.tab.c"
    break;

  case 9: /* exp: exp exp '*'  */
#line 37 "postfix.y"
                   { yyval = yyvsp[-2] * yyvsp[-1]; }
#line 1103 "postfix.tab.c"
    break;
...
#line 38 "postfix.y"
        ...
        if (yyvsp[-1] == 0.0) {
            ...
            yyval = 0; // Prevent crash, assign default value
        } else {
            yyval = yyvsp[-2] / yyvsp[-1]; 
        }
    }
#line 1116 "postfix.tab.c"
    break;

  case 11: /* exp: exp exp '^'  */
#line 46 "postfix.y"
                   { yyval = pow(yyvsp[-2], yyvsp[-1]); }
#line 1122 "postfix.tab.c"
    break;
